...
| 版本 | 日期 | 主要内容 |
| --- | --- | --- |
| v0.1.0 | 2023-11-07 | 基础移动、方块交互和游戏模式 |
| v0.2.0 | 2023-11-10 | 死亡、掉落、飞行和地图扩展 |
| v0.2.1 | 2023-11-11 | 随机地形和渲染优化 |
| v0.2.2 | 2023-11-12 | 工具、耐久、树木和保存优化 |
| v0.2.3 | 2023-11-17 | 时间、光照、火把和草方块变化 |
| v0.3.0 | 2023-11-21 | 背包、怪物、攻击冷却和 UI |
| v0.3.1 | 2023-11-24 | 矿物、工具、合成和工作台 |
| v0.3.2 | 2023-11-25 | 背包快捷操作、中文和物理调整 |
| v0.3.3 | 未确认 | 已知存在，详细历史记录尚未恢复 |
| v0.4.0 | 未确认 | 多人联机与专用服务器 |

首个规范化 GitHub Release 为 `v0.1.0`。后续历史版本将在记录确认后再发布。

## 已知限制

- 当前仓库是历史保存快照，不包含每个旧版本对应的完整源码提交。
- 当前没有附带可验证的原始 `v0.1.0` 安装包。
